...
public interface BookRepository extends JpaRepository<BookModel, Long> {
	...
	void insertData(String bookName, String bookCode, String bookDetails, double price, int quantity, String authorName);
	...
	List<BookModel> getAllForUser(long userId);
